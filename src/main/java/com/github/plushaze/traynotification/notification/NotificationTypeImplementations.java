...
/**
 * Enum that contains default implementations for {@link NotificationType}.
 *
 * @author Marcel
 */
public enum NotificationTypeImplementations implements NotificationType
{
	...
	NotificationTypeImplementations(final String svg, final String paintHex, final int... widthAndHeight)
	{
		this.svg = svg;
